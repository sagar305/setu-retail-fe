...
export const strings = {
  ...
  household: {
    ...
    dataHeading: 'Data',
    clearAll: 'Saara data hatayein',
    clearTitle: 'Saara data hata dein?',
    clearMessage: 'Is phone se har member, kaam aur record hamesha ke liye mit jayega.',
  },
  ...
  form: {
    ...
    noMembers: 'Pehle "Ghar" tab me logon ko jodein, tabhi kaam kisi ke naam ho payega.',
    points: 'Points',
    notes: 'Notes',
